                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="form-group">
                            <textarea name="message" id="message" cols={30} rows={5} className="form-control" placeholder="Message*" required={true} defaultValue={""} />
                        </div>
                    </div>
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            <input type="email" name="email" id="email" className="form-control" placeholder="Email*" required={true} />
                        </div>
                    </div>
                    <div className="col-12 mb-20">
                        ...
                        <label>
                            <input name="name" type="checkbox" defaultValue={1} required={true} />
